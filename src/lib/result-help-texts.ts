...
export const RESULT_FAQ = [
  {
    ...
    answer:
      '両方とも重要ですが、NPVの方がより信頼性が高い指標です。IRRは計算の特性上、複数の解が存在したり、期末の売却価格に大きく影響されることがあります。NPVがプラスでIRRが要求利回りを上回っている投資を選びましょう。',
  },
  {
    question: 'キャッシュフローがマイナスの年があっても大丈夫ですか？',
    answer:
      '初期の数年間がマイナスでも、全体としてプラスになり、資金繰りに問題がなければ大丈夫です。ただし、長期間連続してマイナスの場合は、家賃設定や借入条件の見直しが必要かもしれません。',
  },
  {
    question: '暗黙のキャップレートが市場相場と違う場合どうすればいいですか？',
    answer:
      '前提条件を見直しましょう。高すぎる場合は売却価格の前提が楽観的すぎる可能性があります。インフレ率を下げる、価値逓減率を上げるなどの調整を検討してください。',
  },
  {
    question: 'どの指標が最も重要ですか？',
    answer:
      '単一の指標だけで判断するのは危険です。NPV、IRR、キャッシュフロー、暗黙キャップレートを総合的に見て判断することが重要です。特に初心者の方は、まずNPVがプラスかどうかを確認しましょう。',
  },
] as const
