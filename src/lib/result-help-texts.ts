...
export const RESULT_HELP_TEXTS = {
  ...
  npvAsset: {
    ...
    description: "将来のキャッシュフローを現在価値に割り引いた合計。物件そのものの投資価値を表します。",
    interpretation: {
...
割引率の設定によって大きく変わるため、適切な割引率設定が重要です。`,
  ...
  npvEquity: {
    ...
    description: "借入を活用した場合の自己資本部分の投資価値。レバレッジ効果を反映。",
    interpretation: {
...
レバレッジにより変動幅も大きくなるため、リスクも増大します。`,
  ...
  irrAsset: {
    ...
    description: "物件自体が生み出す年平均の収益率。借入を使わない場合の投資利回り。",
    interpretation: {
...
銀行の定期預金や他の投資商品と比較しやすい指標です。`,
  ...
  irrEquity: {
    ...
    description: "借入を活用した場合の自己資本部分の年平均収益率。レバレッジ効果を反映。",
    interpretation: {
...
高いIRRには相応のリスクが伴うことを理解しましょう。`,
  ...
  salePriceNet: {
    ...
    description: "保有期間終了時の売却価格から、仲介手数料等のコストを差し引いた金額。",
    interpretation: {
...
売却時の市場環境により大きく変動する可能性があります。`,
  ...
  remainingDebtAtExit: {
    ...
    description: "保有期間終了時点での借入金残高。売却代金から返済する必要がある金額。",
    interpretation: {
...
売却時の市場価格下落に備え、残債比率は低めに設定することが安全です。`,
  ...
  implicitCap: {
    ...
    description: "翌年の予想NOIを売却価格で割った利回り。市場相場との整合性確認に使用。",
    interpretation: {
...
export const INDICATOR_GROUPS = {
  profitability: {
    ...
    explanation: "これらの指標は「この投資はやる価値があるか？」を判断するための最重要指標です。"
  },
...
export const RESULT_FAQ = [
  {
    question: "NPVとIRRのどちらを重視すべきですか？",
    answer: "両方とも重要ですが、NPVの方がより信頼性が高い指標です。IRRは計算の特性上、複数の解が存在したり、期末の売却価格に大きく影響されることがあります。NPVがプラスでIRRが要求利回りを上回っている投資を選びましょう。"
  },
  {
    question: "キャッシュフローがマイナスの年があっても大丈夫ですか？",
    answer: "初期の数年間がマイナスでも、全体としてプラスになり、資金繰りに問題がなければ大丈夫です。ただし、長期間連続してマイナスの場合は、家賃設定や借入条件の見直しが必要かもしれません。"
  },
  {
    question: "暗黙のキャップレートが市場相場と違う場合どうすればいいですか？",
    answer: "前提条件を見直しましょう。高すぎる場合は売却価格の前提が楽観的すぎる可能性があります。インフレ率を下げる、価値逓減率を上げるなどの調整を検討してください。"
  },
  {
    question: "どの指標が最も重要ですか？",
    answer: "単一の指標だけで判断するのは危険です。NPV、IRR、キャッシュフロー、暗黙キャップレートを総合的に見て判断することが重要です。特に初心者の方は、まずNPVがプラスかどうかを確認しましょう。"
  }
] as const
...
export function getIndicatorGroup(key: IndicatorGroupKey) {
