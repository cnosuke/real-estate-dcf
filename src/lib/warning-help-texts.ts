...
export const WARNING_HELP_TEXTS: Record<string, WarningHelpInfo> = {
  ...
  unrealistic_inflation: {
    ...
    explanation:
      '設定されたインフレ率が日本の過去実績や将来予測から大きく外れています。過度に楽観的または悲観的な想定は、投資判断を誤る原因となります。',
    impact:
      '家賃収入、運営費、物件価格の将来予測に影響し、最終的な投資収益の計算結果が現実離れしたものになる可能性があります。',
    solutions: [
      '日銀の物価目標（2%）を参考に設定する',
  ...
  high_rent_decay: {
    ...
    explanation:
      '設定された家賃逓減率が一般的な水準を上回っています。過度に高い逓減率は、物件の将来価値を過小評価する原因となります。',
    impact:
      '将来の家賃収入が過度に低く見積もられ、投資魅力度が実際より低く算出される可能性があります。',
    solutions: [
  ...
  high_price_decay: {
    ...
    explanation:
      '設定された価値逓減率が一般的な水準を上回っています。過度に高い逓減率は、売却時の回収額を過小評価する原因となります。',
    impact:
      '売却価格が過度に低く見積もられ、投資の出口戦略が過度に悲観的になる可能性があります。',
    solutions: [
      '築年数と立地を考慮した適切な率を設定',
      '好立地物件は逓減率を低めに設定',
      '将来の再開発予定などの要因を考慮',
  ...
  high_vacancy_rate: {
    ...
    explanation:
      '設定された空室率が市場平均を大きく上回っています。過度に高い空室率は収益性を過小評価する原因となります。',
    impact:
      '賃料収入が過度に低く見積もられ、投資魅力度が実際より低く算出される可能性があります。',
    solutions: [
      '地域の実際の空室率データを調査',
      '物件タイプに応じた適切な率を設定',
      '立地条件や設備状況を考慮',
  ...
  high_ltv_ratio: {
    ...
    explanation:
      '借入額が物件価格に対して過度に高い比率となっています。高LTVは財務リスクを高め、金利上昇時の影響を拡大させます。',
    impact:
      '金利上昇リスクや空室リスクが顕在化した際の返済負担が重くなり、投資の安全性が低下します。',
    solutions: [
      '自己資金比率を20-30%以上に設定',
      '金融機関の融資条件を確認',
      '返済余力を十分に確保',
  ...
  high_interest_rate: {
    ...
    explanation:
      '設定された借入金利が現在の市場水準を大きく上回っています。高金利は投資収益性を大幅に悪化させます。',
    impact:
      '毎月の返済負担が重くなり、キャッシュフローが悪化し、投資収益性が低下します。',
    solutions: [
      '複数の金融機関で条件を比較検討',
      '金利優遇条件の活用を検討',
      '借り換えの可能性を検討',
  ...
  short_loan_term_vs_holding: {
    ...
    explanation:
      '融資の返済期間が投資予定期間より短いため、売却時に残債が発生します。売却価格が残債を下回るリスクがあります。',
    impact:
      '売却時に残債の一括返済が必要となり、売却価格によっては追加資金が必要になる可能性があります。',
    solutions: [
      '返済期間の延長を金融機関に相談',
      '保有期間の延長を検討',
      '繰上返済による残債削減を計画',
  ...
  equity_discount_lower_than_asset: {
    ...
    explanation:
      '通常、借入によるレバレッジはリスクを高めるため、エクイティ割引率はアセット割引率より高く設定すべきです。',
    impact:
      '投資のリスクが過小評価され、実際よりも魅力的な投資に見える可能性があります。',
    solutions: [
  ...
  negative_noi: {
    ...
    explanation:
      '運営費や税金が賃料収入を上回る年があります。これは投資として持続可能でない状況を示しています。',
    impact:
      'その年は物件が赤字となり、追加の資金投入が必要になります。長期的な投資戦略の見直しが必要です。',
    solutions: [
      '家賃設定を市場相場と比較検討',
      '運営費の削減可能性を検討',
      '空室率の改善策を検討',
  ...
  negative_sale_price: {
    ...
    explanation:
      '価格逓減率が過度に高いか、保有期間が長すぎるため、売却時の物件価格が現実的でない値になっています。',
    impact:
      '投資の出口戦略が成立せず、売却による回収が困難になる可能性があります。',
    solutions: [
      '価格逓減率を現実的な値に調整',
      '保有期間を短縮する',
      'インフレ率と逓減率のバランスを見直す',
  ...
  volatile_equity_cashflow: {
    ...
    explanation:
      '借入返済の負担により、年次のキャッシュフローが大きく変動しています。これは資金繰りの問題を引き起こす可能性があります。',
    impact:
      '投資期間中の資金繰りが不安定になり、追加の資金投入が必要になるリスクがあります。',
    solutions: [
      '返済期間の延長を検討',
      '借入金額の削減',
      '金利条件の改善',
  ...
  exit_dependent_investment: {
    ...
    explanation:
      'IRRは高いですが、収益の大部分が期末の売却収入に依存しています。売却価格の変動リスクが大きい投資パターンです。',
    impact:
      '売却時の市場環境や物件状況により、想定収益が大きく変動するリスクがあります。',
    solutions: [
      '売却前提を保守的に見直す',
      '保有期間を延長して運営収益を重視',
      'キャッシュフローの安定性を確認',
  ...
  unrealistic_irr_asset: {
    ...
    explanation:
      '計算されたアセットIRRが一般的な不動産投資の範囲（-95%～500%）を外れています。入力条件に問題がある可能性があります。',
    impact:
      '投資判断の基準となるIRRが信頼できない値となっており、適切な判断ができません。',
    solutions: [
      '入力値を再確認（特に売却価格の前提）',
      'インフレ率と逓減率のバランスを確認',
      '保有期間の妥当性を確認',
  ...
  unrealistic_irr_equity: {
    ...
    explanation:
      '計算されたエクイティIRRが一般的な不動産投資の範囲を外れています。借入条件や投資前提に問題がある可能性があります。',
    impact:
      '自己資本に対するリターンの評価が適切にできず、投資判断に支障をきたします。',
    solutions: [
      '借入条件（金利、期間、金額）を再確認',
      'レバレッジ効果が適切に働いているか確認',
      'キャッシュフローの妥当性を確認',
  ...
  market_inconsistent_cap: {
    ...
    explanation:
      '計算された暗黙のキャップレートが、対象市場の一般的な範囲（1-20%）から外れています。売却前提が非現実的な可能性があります。',
    impact:
      '売却価格の前提が市場実態と合わず、実際の売却時に想定と大きく異なる結果となる可能性があります。',
    solutions: [
      '市場のキャップレート相場を調査',
      '価格逓減率とインフレ率のバランスを調整',
      '類似物件の売却事例を参考にする',
  ...
  irr_no_solution: {
    ...
    explanation:
      'キャッシュフローの特性により、IRRの計算ができませんでした。全てのキャッシュフローが同じ符号（全てプラスまたは全てマイナス）の場合に発生します。',
    impact:
      'IRRによる投資判断ができないため、NPVなど他の指標を重視する必要があります。',
    solutions: [
      '初期投資額（マイナス）があることを確認',
  ...
  irr_convergence_failed: {
    ...
    explanation:
      '数値計算の過程で解が収束せず、正確なIRRを算出できませんでした。複雑なキャッシュフローパターンで発生することがあります。',
    impact:
      '正確なIRRが不明のため、この指標による投資判断は慎重に行う必要があります。',
    solutions: [
      'キャッシュフローの妥当性を再確認',
      'NPVによる判断を重視する',
      '投資期間や条件を調整して再計算',
...
export const WARNING_CATEGORIES = {
  input: {
    title: '入力値の警告',
    description:
      '入力された値が一般的な範囲を外れているか、整合性に問題がある可能性があります。',
    color: 'yellow',
  },
  calculation: {
    title: '計算処理の警告',
  ...
  result: {
    title: '結果の警告',
    description:
      '計算結果が非現実的な値となっており、前提条件の見直しが必要な可能性があります。',
    color: 'red',
  },
  market: {
    title: '市場整合性の警告',
    description:
      '市場相場や一般的な投資基準と比較して、前提条件に疑問がある状況です。',
    color: 'blue',
  },
}
  ...
  items: [
    {
      title: '保守的な前提設定',
      description:
        '楽観的すぎる前提は投資判断を誤る原因となります。むしろ保守的な前提で分析し、それでも投資価値がある物件を選びましょう。',
      importance: 'high',
    },
    {
      title: '複数シナリオでの分析',
      description:
        '楽観・中立・悲観の3つのシナリオで分析し、悲観シナリオでも許容できる結果かを確認しましょう。',
      importance: 'high',
    },
    {
      title: '市場相場との比較',
      description:
        '計算結果は必ず市場相場と比較し、現実的な値かどうかを確認してください。',
      importance: 'medium',
    },
    {
      title: 'キャッシュフローの重視',
      description:
        'IRRやNPVも重要ですが、実際の資金繰りに影響するキャッシュフローの安定性も重視しましょう。',
      importance: 'high',
    },
    {
      title: '専門家への相談',
      description:
        '重要な投資判断の前には、不動産業者、会計士、税理士などの専門家に相談することをお勧めします。',
      importance: 'medium',
    },
    {
      title: '定期的な見直し',
      description:
        '投資実行後も定期的に実績と予測を比較し、必要に応じて戦略を見直しましょう。',
      importance: 'medium',
    },
  ],
}
...
export const COMMON_ISSUES = [
  {
    ...
    explanation:
      '期末の売却収入に大きく依存している「期末頼み」の投資パターンです。',
    risks: [
      '売却価格の変動リスクが大きい',
      '途中のキャッシュフローが薄い',
      '売却時期の制約',
  ...
  },
  {
    ...
    explanation:
      '借入返済の負担により、年次のキャッシュフローが不安定になっているパターンです。',
 ...
 */
export function getWarningHelpInfo(error: {
  type?: string
  message?: string
}): WarningHelpInfo | null {
  ...
  for (const [key, helpInfo] of Object.entries(WARNING_HELP_TEXTS)) {
    if (
      messageKey.includes(key.replace(/_/g, ' ')) ||
  ...
  // 家賃・価格逓減率関連
  if (
    messageKey.includes('家賃') &&
    (messageKey.includes('逓減') || messageKey.includes('下落'))
  ) {
    return WARNING_HELP_TEXTS.high_rent_decay
  }
  if (
    messageKey.includes('価格') &&
    (messageKey.includes('逓減') || messageKey.includes('下落'))
  ) {
  ...
  if (
    messageKey.includes('借入比率') ||
    (messageKey.includes('ltv') && messageKey.includes('高すぎる'))
  ) {
  ...
  if (
    messageKey.includes('売却時の物件価格') &&
    messageKey.includes('ゼロ以下')
  ) {
    return WARNING_HELP_TEXTS.negative_sale_price
  }
  if (
    messageKey.includes('エクイティキャッシュフロー') &&
    messageKey.includes('不安定')
  ) {
    return WARNING_HELP_TEXTS.volatile_equity_cashflow
  }
  if (
    messageKey.includes('期末頼み') ||
    messageKey.includes('売却価格の前提を保守的')
  ) {
  ...
  // キャップレート関連
  if (
    (messageKey.includes('cap') || messageKey.includes('キャップ')) &&
  ...
  // IRR計算エラー関連
  if (
    messageKey.includes('解が存在しない') ||
    messageKey.includes('no solution')
  ) {
    return WARNING_HELP_TEXTS.irr_no_solution
  }
  if (
    messageKey.includes('収束') &&
    (messageKey.includes('failed') || messageKey.includes('しませんでした'))
  ) {
    return WARNING_HELP_TEXTS.irr_convergence_failed
  }
  if (
    messageKey.includes('同じ符号') ||
    messageKey.includes('プラスとマイナス')
  ) {
    return WARNING_HELP_TEXTS.irr_no_solution
  }
